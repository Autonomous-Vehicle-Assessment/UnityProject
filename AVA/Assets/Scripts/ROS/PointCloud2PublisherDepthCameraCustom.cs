...
{
    public class PointCloud2PublisherDepthCameraCustom : UnityPublisher<MessageTypes.Sensor.PointCloud2>
    {
        [Header("Camera Feed")]
        public ImagePublisher imagePublisher;

        [Header("Depth Data")]
        public CameraDepth depthCamera;
        private uint width;
        ...
        private void InitializeMessage()
        {
            message = new MessageTypes.Sensor.PointCloud2
            {
                ...
                height = (uint)depthCamera.height,
                width = (uint)depthCamera.width,

                fields = GetPointField(),

                is_bigendian = false,
                point_step = 12,
                row_step = 12 * (uint)depthCamera.width,
                is_dense = false,
            };
        }
        ...
        private void UpdateMessage()
        {
            ...
            message.header = imagePublisher.message.header;
        ...
        {
            Vector3[] depths = depthCamera.GetVehicleDepthArray();
