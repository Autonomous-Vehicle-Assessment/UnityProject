...
{
    public class WaypointSubscriberCustom : UnitySubscriber<MessageTypes.Geometry.PoseStamped>
    {
        ...
        {
            pathNode.transform.position = new Vector3(position.x,200,position.z);
            pathNode.transform.rotation = rotation;
